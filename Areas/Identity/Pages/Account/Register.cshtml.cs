...
namespace CS_58_TichHop_EntityFramework.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [EmailAddress(ErrorMessage ="Sai định dạng Emai!")]
            [Display(Name = "Email")]
            ...
            /// </summary>
            [Required]
            [StringLength(100, ErrorMessage = " {0} phải dài từ {2} tới {1} ký tự.", MinimumLength = 2)]
