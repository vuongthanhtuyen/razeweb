...
namespace App.Admin.Role
{
    ...
    {
        public EditRoleClaimModel(RoleManager<IdentityRole> roleManager, MyBlogContent myBlogContext) : base(roleManager, myBlogContext)
        {
        ...
        {
            if(claimid==null)return NotFound("kHông tìm thất role");
            ...
            if(role ==null)return NotFound("Không tìm thất role");
        ...
        public async Task<IActionResult> OnPostAsync(int? claimid)
        {
            ...
            // check nếu lấy tên mới gt mới thì có trùng với giá trị nào trong csdl không?
            if (_context.RoleClaims.Any(c => c.RoleId == role.Id && c.ClaimType == Input.ClaimType && c.ClaimValue == Input.ClaimValue && c.Id != claim.Id))
            {
                ModelState.AddModelError(string.Empty, "Claim này đã có trong Claim");
                return Page();
            }
        ...
        public async Task<IActionResult> OnPostDeleteAsync(int? claimid){
            ...
            StatusMessage ="Vừa xóa claim thành công";
